 ...
 * Author: santi
 *
 * Created on 7 de mayo de 2025, 08:44 PM
 */
...
#define EN LATD2                  /*PIN 1 of PORTD is assigned for enable Pin of LCD */
#define ldata LATD                  /*PORTB(PD4-PD7) is assigned for LCD Data Output*/ 
